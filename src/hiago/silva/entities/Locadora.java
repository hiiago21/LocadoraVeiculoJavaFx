			...
			while(line != null) {
				...
				if(tipo.equals("V")) {
					...
					case "P":
						...
						Passeio p = new Passeio(Integer.parseInt(ano),
								Long.parseLong(kmRodado),
								marca,
								modelo,
								placa,
								Boolean.parseBoolean(luxo),
								Integer.parseInt(nroPortas),
								Integer.parseInt(potencia));
					...
					case "M":
						 ...
						 potencia = dados[6];
						Moto m = new Moto(Integer.parseInt(ano),
								Long.parseLong(kmRodado),
								marca,
								modelo,
								placa,
								Estilo.valueOf(estiloMoto.toUpperCase()),
								Integer.parseInt(potencia));
					...
					case "C":
						...
						Caminhao c = new Caminhao(Integer.parseInt(ano),
								Long.parseLong(kmRodado),
								marca,
								modelo,
								placa,
								Long.parseLong(cargaMaxima),
								Integer.parseInt(nrEixos),
